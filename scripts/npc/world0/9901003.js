 ...
 * @Author:      Quanta
 * @NPC:         9901001
 * @Purpose:     Gives a starter pack for Cygnus
 */
...
function action(mode, type, selection) {
    if (mode < 0) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
			cm.sendSimple("#dGreetings! \r \r#bMy name is ^-`JokerstaR, I am an adminitrator on ArchonMS. Our server is full of adventures! Before you leave, I'll give you a super awesome special starter kit! But first, let me know where are you heading to? #b\r\n#L0#I want to do the tutorial, take me to the next map!\r\n#L1#I want to skip the tutorial, take me to Ereve!\r\n#L2#Let me think a bit");
		} else if (status == 1) {
			if (selection == 0) {
